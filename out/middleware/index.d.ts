...
export declare type ClientNextCaller<R = void> = (...args: ReadonlyArray<unknown>) => R;
...
export declare type ClientMiddlewareOverload<T extends readonly unknown[]> = [
] | [
    clientMiddleware<T>
] | [
    clientMiddleware,
...
export declare type clientMiddleware<CallArguments extends ReadonlyArray<unknown> = Array<unknown>, PreviousCallArguments extends ReadonlyArray<unknown> = Array<unknown>> = (next: (...args: CallArguments) => void, event: NetManagedInstance) => (...args: PreviousCallArguments) => void;
...
export declare type ClientNetGlobalMiddleware = (next: (...args: readonly unknown[]) => void, event: Readonly<NetManagedInstance>) => (...args: readonly unknown[]) => void;
