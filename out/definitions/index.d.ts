...
declare namespace NetDefinitions {
     ...
     */
    function ServerFunction<ServerFunction extends (...args: any[]) => any>(mw?: MiddlewareOverload<Parameters<ServerFunction>>, cmv?: ClientMiddlewareOverload<unknown[]>): FunctionDeclaration<Parameters<ServerFunction>, ReturnType<ServerFunction>>;
    /**
    ...
    function ServerToClientEvent<ServerArgs extends readonly unknown[] = unknown[]>(mv?: ClientMiddlewareOverload<ServerArgs>): ServerToClientEventDeclaration<ServerArgs>;
    /**
